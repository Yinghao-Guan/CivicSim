...
| [`03-api-contract.md`](./03-api-contract.md) | The frontend/backend wire format: endpoints, field names, units, coordinate order, canonical site ids, and the change procedure. Covers `/baseline`, `/simulate`, `/scenario/{id}`, `/cooling/nearest` and `/ai/recommend`. |
